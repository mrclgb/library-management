      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="fa fa-address-card collapse-item" href="#">&emsp;Contact List</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <p class="text-danger">Please contact Web Admin if you want to change ID Number</p>
         <!-- Begin Page Content -->
                <div class="container-fluid">
                  ...
                  <div class="card shadow mb-4">
                    <div class="card-header py-3">
                      ...
                      <?php
                      if(isset($_SESSION['contactListMsg'])){
                          echo $_SESSION['contactListMsg'];
                          session_destroy();
                      }
                      ...
                      if(isset($_SESSION['update_contact'])){
                          echo $_SESSION['update_contact'];
                          session_destroy();
                      }
                      ?>
                      </div>
                    <div class="card-body">
                      <div class="table-responsive">
                          ...
                          if (!$result) {
                              ...
                              $_SESSION['contactListMsg'] = $string;
                              ...
                              echo "<td><a class='btn btn-danger btn-sm' href=edit/delete_contact.php?id_number=".$row['IDNumber'].">
                                    <i class='fas fa-trash fa-sm'> Delete</i></a>";
                              echo "<a class='btn btn-info btn-sm' href=edit_update_contact.php?id_number=".$row['IDNumber'].">
