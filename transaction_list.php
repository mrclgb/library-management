                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="fa fa-barcode m-0 font-weight-bold text-info"> Transaction List</h6>
                        </div>
                        <div class="container-fluid">
                            <?php if (isset($_SESSION['transactionListMsg'])){
                                echo $_SESSION['transactionListMsg'];
                                session_destroy();
                            }
                            if(isset($_SESSION['delete_transaction'])){
                                echo $_SESSION['delete_transaction'];
                                session_destroy();
                            }
                            if(isset($_SESSION['update_transaction'])){
                                echo $_SESSION['update_transaction'];
                                session_destroy();
                            }
                            ?>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                $query = "SELECT Transactions.TransactionsID, Contacts.FirstName, Contacts.LastName, Assets.BookName, Transactions.CheckedOutDate, Transactions.DueDate, Transactions.CheckedInDate, Transactions.CheckedOutCondition, Transactions.CheckedInCondition ";
                                $query .= "FROM Contacts ";
                                $query .= "JOIN Transactions ON Contacts.ContactsID = Transactions.ContactsID ";
                                $query .= "JOIN Assets ON Transactions.AssetsID = Assets.AssetsID";
                                ...
                                <span aria-hidden='true'>&times;</span>
                                    ...
                                    $_SESSION['transactionListMsg'] = $string;
                                } else {
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        ...
                                        echo "<td>".$row['CheckedOutDate']."</td>";
                                        echo "<td>".$row['DueDate']."</td>";
                                        echo "<td>".$row['CheckedInDate']."</td>";
                                        echo "<td>".$row['CheckedOutCondition']."</td>";
                                        echo "<td>".$row['CheckedInCondition']."</td>";
                                        echo "<td><a class='btn btn-danger btn-sm' href=edit/delete_transaction.php?id_number=".$row['TransactionsID'].">
                                        <i class='fas fa-trash fa-sm'> Delete</i></a>";
                                        echo "<a class='btn btn-info btn-sm' href=edit_update_transaction.php?id_number=".$row['TransactionsID'].">
