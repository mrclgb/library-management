                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="fa fa-comment m-0 font-weight-bold text-info"> Comment List</h6>
                        </div>
                        <div class="container-fluid">
                            <?php if (isset($_SESSION['commentListMsg'])){
                                echo $_SESSION['commentListMsg'];
                                session_destroy();
                            }
                            if(isset($_SESSION['delete_comment'])){
                                echo $_SESSION['delete_comment'];
                                session_destroy();
                            }
                            if(isset($_SESSION['update_comment'])){
                                echo $_SESSION['update_comment'];
                                session_destroy();
                            }
                            ?>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <span aria-hidden='true'>&times;</span>
                                    ...
                                    $_SESSION['commentListMsg'] = $string;
                                } else {
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        echo "<tr>";
                                        echo "<td>".$row['CommentsID']."</td>";
                                        echo "<td>".$row['BookName']."</td>";
                                        echo "<td>".$row['Comments']."</td>";
                                        echo "<td><a class='btn btn-danger btn-sm' href=edit/delete_comment.php?id_number=".$row['CommentsID'].">
                                        <i class='fas fa-trash fa-sm'> Delete</i></a>";
                                        echo "<a class='btn btn-info btn-sm' href=edit_update_comment.php?id_number=".$row['CommentsID'].">
