...
// Check for address:
    ...
    if (empty($errors)) {
        try {
            ...
            $query .= "VALUES( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
//            echo $id, $firstname, $lastname, $dob, $gender, $status, $sp, $citizen, $email, $mobilephone, $telephone, $address;
            $prepare = mysqli_stmt_init($conn);
            mysqli_stmt_prepare($prepare, $query);
            mysqli_stmt_bind_param($prepare, 'ssssssssssss', $id, $firstname, $lastname, $dob, $gender, $status, $sp, $citizen, $email, $mobilephone, $telephone, $address);
