                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-info"> Comment List</h6>
                        </div>
                        <div class="container-fluid">
                            <?php if (isset($_SESSION['contactListMsg'])) {
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                $query = "SELECT Comments.Comments ";
                                $query .= "FROM Assets ";
                                $query .= "LEFT JOIN Comments ON Assets.AssetsID = Comments.AssetsID ";
                                $query .= "WHERE Comments.AssetsID=$id";
//                                echo $query;
